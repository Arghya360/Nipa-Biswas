...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { icon: Linkedin, href: "https://www.linkedin.com/in/nipa-biswas-7a2285327?utm_source=share_via&utm_content=profile&utm_medium=member_android", label: "LinkedIn" },
    { icon: Facebook, href: "https://www.facebook.com/share/1HBRuFb7iv/", label: "Facebook" },
    { icon: Instagram, href: "https://www.instagram.com/nipa58137?igsi=enFreW1ra3ZpYzc=", label: "Instagram" },
  ];
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="https://wa.me/8801318476188"
                  className="text-muted-foreground hover:text-primary transition-colors text-sm"
                >
                  +880 1318-476188 (WhatsApp)
                </a>
              </li>
              <li>
                <a
                  href="mailto:nipabiswas702@gmail.com"
                  className="text-muted-foreground hover:text-primary transition-colors text-sm"
                >
                  nipabiswas702@gmail.com
                </a>
              </li>
            </ul>
          </div>
