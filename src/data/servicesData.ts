import { Code, Palette, Smartphone, Globe, Database, Rocket, Layout, ShoppingCart, Layers, TrendingUp } from "lucide-react";
...
export const servicesData: ServiceDetail[] = [
  ...
  },
  {
    ...
    subtitle: "Growth & Visibility Strategy",
    ...
    longDescription: "I provide end-to-end digital marketing services that help your business grow online. From social media management to SEO and paid advertising, I develop data-driven strategies that reach your target audience and deliver measurable results.",
    icon: "TrendingUp",
    heroImage: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=1200&h=600&fit=crop",
    features: ["Social Media Marketing", "Search Engine Optimization", "Search Engine Marketing", "Google & Facebook Ads", "Content Marketing", "Email Marketing", "Lead Generation", "Analytics & Reporting"],
    process: [
      { step: "Audit", description: "Analyzing your current digital presence and competitive landscape." },
      { step: "Strategy", description: "Developing a comprehensive marketing strategy aligned with your business goals." },
      { step: "Execution", description: "Implementing campaigns across multiple channels with continuous optimization." },
      { step: "Analysis", description: "Tracking metrics and ROI with detailed reporting and recommendations." },
    ],
    technologies: ["Google Analytics", "Google Ads", "Facebook Business Manager", "SEMrush", "Hootsuite", "Mailchimp"],
    benefits: [
      { title: "Increased Visibility", description: "Higher search rankings and social media reach for your target audience." },
      { title: "Quality Leads", description: "Data-driven campaigns that attract qualified prospects ready to convert." },
      { title: "Better ROI", description: "Optimized ad spend with detailed tracking and transparent reporting." },
      { title: "Brand Authority", description: "Consistent content strategy that establishes you as an industry leader." },
    ],
  },
];
